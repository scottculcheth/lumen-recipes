...
class RecipeFaker
{
    ...
    public static function createFakeRecipe()
    {
        ...
        $recipe['short_title'] = '';
        $recipe['marketing_description'] = $faker->text(200);
        ...
        $recipe['bulletpoint1'] = $faker->text(200);
        $recipe['bulletpoint2'] = $faker->text(200);
        $recipe['bulletpoint3'] = $faker->text(200);
        ...
        $recipe['in_your_box'] = $faker->text(200);
